...
/**
 * The Class <b>NotSupportedOperationException</b>. This Exception is thrown
 * when the operator is not from the predifined set of allowed operators.
 * 
...
public class NotSupportedOperationException extends Exception {
	 ...
	 */
	private static final long serialVersionUID = -2997864426964475884L;

	/**
	 * Instantiates NotSupportedOperationException exception.
	 *
